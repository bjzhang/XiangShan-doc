...
[上述reserved bit在Plic代码有处理](https://github.com/OpenXiangShan/rocket-chip/blob/175dfe096e3b7c630f93ef328df1cf0b2ed55de1/src/main/scala/devices/tilelink/Plic.scala#L119)
```
  ResourceBinding {
